    ...
    : QMainWindow(parent)
{
    ...
    openTasks->setStyleSheet( " background-color: #303030; color: #ffffff; border-color: #000000; alternate-background-color: #303030;" );
    ...
    openNotes->setStyleSheet( " background-color: #303030; color: #ffffff; border-color: #000000; alternate-background-color: #303030;" );
    ...
    openTimer->setStyleSheet( " background-color: #303030; color: #ffffff; border-color: #000000; alternate-background-color: #303030;" );
